def get_wonwha_string(num_wonwha_amout):
    ...
    if num_change >= 1000000000000000:  #1경 이상
        str_result += f"{int(num_change // 100000000000000):,}조"
        num_change = num_change % 100000000000000
    if num_change >= 1000000000000:  #1조 이상
        str_result += f" {int(num_change // 100000000000):,}조"
        num_change = num_change % 100000000000
...
# print(get_wonwha_string(258234220012300))
# print(get_wonwha_string(-258234220012300))